...
return [
    ...
    */
    ...
    'not_in' => 'Недопустимое значение поля ":attribute"',
    ...
    */
    ...
    'attributes' => [
        ...
        'data.country' => 'Страна',
        'data.current_password' => 'Текущий пароль',
        'data.date' => 'Дата',
        'data.day' => 'День',
        'data.default' => 'По умолчанию',
        'data.description' => 'Описание',
        'data.division' => 'Подразделение',
        'data.division_id' => 'Подразделение',
        'data.email' => 'E-Mail адрес',
        'data.enabled' => 'Включено',
        'data.first_name' => 'Имя',
        'data.gender' => 'Пол',
        'data.hour' => 'Час',
        'data.last_name' => 'Фамилия',
        'data.middle_name' => 'Отчество',
        'data.minute' => 'Минута',
        'data.mobile' => 'Моб. номер',
        'data.month' => 'Месяц',
        'data.name' => 'Название',
        'data.password' => 'Пароль',
        'data.password_confirmation' => 'Подтверждение пароля',
        'data.phone' => 'Телефон',
        'data.remember_me' => 'Запомнить меня',
        'data.second' => 'Секунда',
        'data.sex' => 'Пол',
        'data.size' => 'Размер',
        'data.status' => 'Статус',
