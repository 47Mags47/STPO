...
<tbody>
    <tr>
        ...
        <x-table.td type="input" value="{{ $data->has('BT5') ? $data['BT5'] : '' }}" name="BT5" />
        <x-table.td type="input" value="{{ $data->has('CG5') ? $data['CG5'] : '' }}" name="CG5" />
        <x-table.td type="input" value="{{ $data->has('CH5') ? $data['CH5'] : '' }}" name="CH5" />
    </tr>
</tbody>
