...
<tbody>
    ...
    <tr>
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI8') ? $data['CI8'] : '' }}" name="CI8" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ8') ? $data['CJ8'] : '' }}" name="CJ8" />
    </tr>
    <tr>
    ...
    <tr>
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI12') ? $data['CI12'] : '' }}" name="CI12" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ12') ? $data['CJ12'] : '' }}" name="CJ12" />
    </tr>
    <tr>
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI13') ? $data['CI13'] : '' }}" name="CI13" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ13') ? $data['CJ13'] : '' }}" name="CJ13" />
    </tr>
    <tr>
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI14') ? $data['CI14'] : '' }}" name="CI14" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ14') ? $data['CJ14'] : '' }}" name="CJ14" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере социальной защиты населения" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI15') ? $data['CI15'] : '' }}" name="CI15" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ15') ? $data['CJ15'] : '' }}" name="CJ15" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере образования" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI16') ? $data['CI16'] : '' }}" name="CI16" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ16') ? $data['CJ16'] : '' }}" name="CJ16" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере занятости населения" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI17') ? $data['CI17'] : '' }}" name="CI17" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ17') ? $data['CJ17'] : '' }}" name="CJ17" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере физической культуры и спорта" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI18') ? $data['CI18'] : '' }}" name="CI18" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ18') ? $data['CJ18'] : '' }}" name="CJ18" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере культуры" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI19') ? $data['CI19'] : '' }}" name="CI19" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ19') ? $data['CJ19'] : '' }}" name="CJ19" />
    </tr>
    <tr>
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI20') ? $data['CI20'] : '' }}" name="CI20" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ20') ? $data['CJ20'] : '' }}" name="CJ20" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере социальной защиты населения" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI21') ? $data['CI21'] : '' }}" name="CI21" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ21') ? $data['CJ21'] : '' }}" name="CJ21" />
    </tr>
    <tr>
        <x-table.td type="header" value=">в сфере образования" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI22') ? $data['CI22'] : '' }}" name="CI22" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ22') ? $data['CJ22'] : '' }}" name="CJ22" />
    </tr>
    <tr>
        <x-table.td type="header" value=">в сфере занятости населения" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI23') ? $data['CI23'] : '' }}" name="CI23" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ23') ? $data['CJ23'] : '' }}" name="CJ23" />
    </tr>
    <tr>
        <x-table.td type="header" value=">в сфере физической культуры и спорта" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI24') ? $data['CI24'] : '' }}" name="CI24" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ24') ? $data['CJ24'] : '' }}" name="CJ24" />
    </tr>
    <tr>
        <x-table.td type="header" value=">в сфере культуры" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI25') ? $data['CI25'] : '' }}" name="CI25" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ25') ? $data['CJ25'] : '' }}" name="CJ25" />
    </tr>
    <tr>
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI26') ? $data['CI26'] : '' }}" name="CI26" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ26') ? $data['CJ26'] : '' }}" name="CJ26" />
    </tr>
    <tr>
        <x-table.td type="header" value=">в сфере социальной защиты населения" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI27') ? $data['CI27'] : '' }}" name="CI27" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ27') ? $data['CJ27'] : '' }}" name="CJ27" />
    </tr>
    <tr>
        <x-table.td type="header" value=">в сфере образования" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI28') ? $data['CI28'] : '' }}" name="CI28" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ28') ? $data['CJ28'] : '' }}" name="CJ28" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере занятости населения" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI29') ? $data['CI29'] : '' }}" name="CI29" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ29') ? $data['CJ29'] : '' }}" name="CJ29" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере физической культуры и спорта" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI30') ? $data['CI30'] : '' }}" name="CI30" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ30') ? $data['CJ30'] : '' }}" name="CJ30" />
    </tr>
    <tr>
        <x-table.td type="header" value="в сфере культуры" />
        ...
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CI31') ? $data['CI31'] : '' }}" name="CI31" />
        <x-table.td type="input" inp-type="number" value="{{ $data->has('CJ31') ? $data['CJ31'] : '' }}" name="CJ31" />
    </tr>
</tbody>
