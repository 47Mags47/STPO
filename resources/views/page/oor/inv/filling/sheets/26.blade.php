...
<tbody>
    ...
    <tr>
        <x-table.td type="header" value="по оснащению (оборудованию) специального рабочего места для трудоустройства инвалида" />
    ...
    <tr>
        <x-table.td type="header" value=" Количество инвалидов, которым органом исполнительной власти субъекта Российской Федерации в сфере социальной защиты населения были реализованы мероприятия по реабилитации и абилитации, предусмотренные ИПРА/ИПР инвалида и ИПРА/ИПР ребенка-инвалида, в том числе" />
    ...
    <tr>
        <x-table.td type="header" value="Количество инвалидов, которым органом исполнительной власти субъекта Российской Федерации в сфере физической культуры и спорта были реализованы мероприятия по реабилитации и абилитации, предусмотренные ИПРА/ИПР инвалида и ИПРА/ИПР ребенка-инвалида" />
    ...
    <tr>
        <x-table.td type="header" value=" Количество инвалидов, которым были реализованы мероприятия по обеспечению техническими средствами реабилитации и услугами по реабилитации, предусмотренными ИПРА/ИПР инвалида и ИПРА/ИПР ребенка-инвалида, за счет средств федерального бюджета, в том числе" />
    ...
    <tr>
        <x-table.td type="header" value=" Количество инвалидов, которым были реализованы мероприятия по обеспечению техническими средствами реабилитации и услугами по реабилитации, предусмотренными ИПРА/ИПР инвалида и ИПРА/ИПР ребенка-инвалида, за счет средств бюджета субъекта Российской Федерации, в том числе" />
