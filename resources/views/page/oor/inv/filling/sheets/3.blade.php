...
<tbody>
    <tr>
        ...
        <x-table.td type="input" value="{{ $data->has('CK7') ? $data['CK7'] : '' }}" name="CK7" />
        <x-table.td type="input" value="{{ $data->has('CL7') ? $data['CL7'] : '' }}" name="CL7" />
        <x-table.td type="input" value="{{ $data->has('CM7') ? $data['CM7'] : '' }}" name="CM7" />
        <x-table.td type="input" value="{{ $data->has('CN7') ? $data['CN7'] : '' }}" name="CN7" />
    </tr>
    <tr>
    ...
    <tr>
        ...
        <x-table.td type="input" value="{{ $data->has('CK10') ? $data['CK10'] : '' }}" name="CK10" />
        <x-table.td type="input" value="{{ $data->has('CL10') ? $data['CL10'] : '' }}" name="CL10" />
        <x-table.td type="input" value="{{ $data->has('CM10') ? $data['CM10'] : '' }}" name="CM10" />
        <x-table.td type="input" value="{{ $data->has('CN10') ? $data['CN10'] : '' }}" name="CN10" />
    ...
    <tr>
        ...
        <x-table.td type="input" value="{{ $data->has('CK11') ? $data['CK11'] : '' }}" name="CK11" />
        <x-table.td type="input" value="{{ $data->has('CL11') ? $data['CL11'] : '' }}" name="CL11" />
        <x-table.td type="input" value="{{ $data->has('CM11') ? $data['CM11'] : '' }}" name="CM11" />
        <x-table.td type="input" value="{{ $data->has('CN11') ? $data['CN11'] : '' }}" name="CN11" />
    </tr>
