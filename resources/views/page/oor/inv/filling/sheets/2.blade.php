...
<tbody>
    ...
    <tr>
        <x-table.td type="header"
            value="Общая численность инвалидов в возрасте 18 лет и старше и детей-инвалидов, в том числе" />
    ...
    <tr>
        ...
        <x-table.td type="input" value="{{ $data->has('CF9') ? $data['CF9'] : '' }}" coord="CF9" />
        <x-table.td type="input" value="{{ $data->has('CG9') ? $data['CG9'] : '' }}" coord="CG9" />
        <x-table.td type="input" value="{{ $data->has('CH9') ? $data['CH9'] : '' }}" coord="CG9" />
    ...
    <x-table.td type="header" value="Численность детей-инвалидо" />
