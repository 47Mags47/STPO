...
class AppealSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Glossary_Csvi_Appeal_Them::create(['id' => 3, 'name' => 'Предложения', 'category_id' => 1]);
        ...
        Glossary_Csvi_Appeal_Them::create(['id' => 15, 'name' => 'ГИС КС | Dijit МЭВ', 'category_id' => 5]);
        Glossary_Csvi_Appeal_Them::create(['id' => 16, 'name' => 'ЕГИСО', 'category_id' => 6]);
        Glossary_Csvi_Appeal_Them::create(['id' => 18, 'name' => 'Проблема с IP-телефоном', 'category_id' => 2]);
        Glossary_Csvi_Appeal_Them::create(['id' => 19, 'name' => 'Шаблоны', 'category_id' => 3]);
